        ...
        egui::CentralPanel::default().show_inside(ui, |ui| {
            egui::ScrollArea::vertical().show(ui, |ui| {
                ...
                commonmark_str!(
                    ui,
                    &mut self.cache,
                    "src/markdown/definition_list.md"
                );
                commonmark!(ui, &mut self.cache, "------------");
            });
        });
